                ...
                <div class="col-md-12">
                    <div class="search-result bg-gray">
                        ...
                        <div class="form-group">
                            ...
                            {!!Form::select('category[]', $category, '',array('class' => 'tag_list','multiple', 'autofocus'))!!}
                        </div><br/>
                        ...
                        <div class="form-group">
                            ...
                            {!!Form::textarea('paper_abstract', '',array('class' => 'summernote form-control','placeholder' =>  '...................'))!!}
                        </div><br/>
                        ...
                        <div class="form-group">
                            ...
                            {!!Form::text('paper_published_at', '',array('class' => 'form-control','placeholder' =>  'Publication Name here'))!!}
                        </div><br/>

                        <div class="form-group">
                            {!! Form::label('author', 'Select Paper Author:', array('class' => 'control-label')) !!}<br/>
                            {!!Form::select('author[]', $users, '',array('class' => 'tag_list','multiple', 'autofocus'))!!}
                        </div><br/>

                        <div class="form-group">
                            {!! Form::label('paper_published_url', 'Paper Published Url(optional) :', array('class' => 'control-label')) !!}<br/>
                            {!!Form::text('paper_published_url', '',array('class' => 'form-control','placeholder' =>  'Paper url here'))!!}
                        </div><br/>
